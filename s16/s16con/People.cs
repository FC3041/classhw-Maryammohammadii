...
class Teacher : Citizen
{
    ...
    public Teacher(string fname, string lname, int id, bool isMale,
                   int employeeId, double salary, float rating)
    ...
    public override string ToString()
    {
        return $"{base.ToString()} - EmpId:{EmployeeId}, Salary:{Salary}, Rating:{Rating}";
    }
}
